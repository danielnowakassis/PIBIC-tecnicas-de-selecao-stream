...
public class ARFm extends AdaptiveRandomForest {
	...
	public IntOption density_control_size = new IntOption("density_control_size", 'ç',
			"Size of the sliding window", 500, 1, Integer.MAX_VALUE);
	public int acertos = 0;
	FileWriter fWriter;
	//public long n_classifiers_total;
	public int media = 0;
	public int inst_min = 500 / 100;
    ...
    public double[] getVotesForInstance(Instance instance) {
        ...
        for(int i = 0 ; i < this.ensemble.length ; ++i) {
            ...
            if (vote.sumOfValues() > 0.0) {
                ...
                if(correctlyclassified_c >= media) {
